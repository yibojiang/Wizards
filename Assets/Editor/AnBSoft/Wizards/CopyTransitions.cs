...
public class CopyTransitions : ScriptableObject
{
	...
	static void CopyControl(IControl ctl)
	{
		...
		if ( Wizards.Utils.DEBUG ) Debug.Log(num + " transition lists Copied");
	}
	...
	static void CopyPanel(UIPanelBase panel)
	{
		...
		if ( Wizards.Utils.DEBUG ) Debug.Log("Transitions Copied");
	}
	...
	static void PasteControl(IControl ctl)
	{
		...
		if ( Wizards.Utils.DEBUG ) Debug.Log(i + " transition lists Pasted");
	}
	...
	static void PastePanel(UIPanelBase panel)
	{
		...
		if ( Wizards.Utils.DEBUG ) Debug.Log("Transitions Pasted");
	}
}
