...
public class SpriteText : MonoBehaviour, IUseCamera 
{
	...
	protected virtual void Awake()
	{
		...
		if (meshRenderer.sharedMaterial != null)
			...
			if ( Wizards.Utils.DEBUG ) Debug.LogWarning("Text on GameObject \"" + name + "\" has not been assigned a material.");
#endif
	...
	protected virtual void Init()
	{
		...
		if (font != null)
		{
			...
			if (spriteFont == null)
				if ( Wizards.Utils.DEBUG ) Debug.LogWarning("Warning: " + name + " was unable to load font \"" + font.name + "\"!");
		}
		else if(Application.isPlaying)
			if ( Wizards.Utils.DEBUG ) Debug.LogWarning("Warning: " + name + " currently has no font assigned.");
...
//			gameObject.active = ((Component)parentControl).gameObject.active;
	...
	// than 10 seconds:
#if (UNITY_3_0 || UNITY_3_1 || UNITY_3_2 || UNITY_3_3 || UNITY_3_4 || UNITY_3_5 || UNITY_3_6 || UNITY_3_7 || UNITY_3_8 || UNITY_3_9 || UNITY_4_1 || UNITY_4_2 || UNITY_4_3) && UNITY_EDITOR
	void Update() 
	{
		DoMirror();
	}
