	...
	public virtual string Text
	{
		...
		set
		{
			...
			if (spriteText == null)
			{
				...
				{
					if ( Wizards.Utils.DEBUG ) Debug.LogWarning("Warning: No UIManager exists in the scene. A UIManager with a default font is required to automatically add text to a control.");
					return;
				}
				else if (UIManager.instance.defaultFont == null)
				{
					if ( Wizards.Utils.DEBUG ) Debug.LogWarning("Warning: No default font defined.  A UIManager object with a default font is required to automatically add text to a control.");
					return;
				}
